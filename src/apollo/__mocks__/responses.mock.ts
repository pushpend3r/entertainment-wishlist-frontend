import { Get_New_TokensMutation } from "../../gql/graphql";

export const SUCCESS_RESPONSE_GET_TRENDING_QUERY = {
  data: {
    trending: {
      movies: [
        {
...
export const FAILED_RESPONSE_GET_TRENDING_QUERY = {
  errors: [
    {
...
export const RESPONSE_401_ERROR = {
  errors: [
    {
...
export const RESPONSE_200_GET_NEW_TOKENS: { data: Get_New_TokensMutation } = {
  data: {
    getNewTokens: {
